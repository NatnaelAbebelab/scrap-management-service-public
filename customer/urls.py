...
urlpatterns = [
    ...
    path('filter-customer-grn/', views.filter_customer_grn, name='filter_customer_grn'),
    ...
    path('get-customer-net-pay-summery/', views.customer_net_pay_summary, name='customer_net_pay_summary'),
